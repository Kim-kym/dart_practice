...
strings() {
  ...
  //  문자열 보간 : 문자열 내부에 변수, 표현식 결과를 포함시킨다.
  ...
  List<String> fruitList = fruits.split(",");  //  ,를 기준으로 분리, 제네릭을 쓴 이유는 데이터 타입 제한을 위해
  print("원본 문자열: $fruits");
